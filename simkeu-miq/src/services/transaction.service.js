...
export const getTransactions = async (params = {}) => {
  ...
  return api.get('?action=transactions', { params })
}
...
export const getTransaction = async (id) => {
  ...
  return api.get(`?action=transaction&id=${id}`)
}
...
export const addTransaction = async (payload) => {
  ...
  return api.post('?action=addTransaction', payload)
}
...
export const updateTransaction = async (id, payload) => {
  ...
  return api.put(`?action=updateTransaction&id=${id}`, payload)
}
...
export const deleteTransaction = async (id) => {
  ...
  return api.delete(`?action=deleteTransaction&id=${id}`)
}
...
export const getDashboard = async () => {
  ...
  return api.get('?action=dashboard')
}
